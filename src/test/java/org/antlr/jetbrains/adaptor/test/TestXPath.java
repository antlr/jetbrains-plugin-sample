...
public class TestXPath extends ParsingTestCase {
	...
	public void testFuncNames() throws Exception {
		String code = loadFile("src/test/java/org/antlr/jetbrains/adaptor/test/test.sample");
		String output =
			"f\n"+
			"g\n"+
			"h";
	...
	public void testAllVarDefIDsInScopes() throws Exception {
		String code = loadFile("src/test/java/org/antlr/jetbrains/adaptor/test/bubblesort.sample");
		String output =
			"x\n"+
			"i\n"+
			"j\n"+
